namespace Microsoft.ApplicationInsights.Extensibility.PerfCounterCollector.Implementation.QuickPulse
{
    ...
    internal interface IQuickPulseServiceClient
    {
        ...
        bool? Ping(string instrumentationKey, DateTimeOffset timestamp, string configurationETag, out CollectionConfigurationInfo configurationInfo);
        ...
        bool? SubmitSamples(IEnumerable<QuickPulseDataSample> samples, string instrumentationKey, string configurationETag, out CollectionConfigurationInfo configurationInfo, string[] collectionConfigurationErrors);
    }
}