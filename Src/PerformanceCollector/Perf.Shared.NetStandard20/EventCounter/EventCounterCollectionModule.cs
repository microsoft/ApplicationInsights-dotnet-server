...
namespace Microsoft.ApplicationInsights.Extensibility.EventCounterCollector
{
    ...
    ///
    /// Following shows example on how to enable this in Asp.Net Core Application.
    ...
    /// 
    /// Following shows example on how to enable this in Asp.Net Application using ApplicationInsights.Config
    /// 
    /// <TelemetryModules>
    ///  <Add Type="Microsoft.ApplicationInsights.Extensibility.EventCounterCollector.EventCounterCollectionModule, Microsoft.AI.PerfCounterCollector">
    ///  <Counters>
    ///     <Add EventSourceName="System.Runtime" EventCounterName="gc-heap-size" />
    ///     <Add EventSourceName="System.Runtime" EventCounterName="gen-0-gc-count" />
    ///     <Add EventSourceName="System.Runtime" EventCounterName="gen-1-gc-count" />
    ///  </Counters>
    /// </Add>
    /// </TelemetryModules>
    /// 
