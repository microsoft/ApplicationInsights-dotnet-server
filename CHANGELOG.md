...
## Version 2.11.0-beta2
 ...
 - [QuickPulse/LiveMetrics background thread safeguards added to never throw unhandled exception. Also moved NETCORE to use Thread implementation as opposed to Task implementation](https://github.com/microsoft/ApplicationInsights-dotnet-server/issues/1088)
